...
function affichevisit(article) {
     var articlesElt = document.getElementById("id");
        ...
        var titrevisite = document.createElement("h2");
        titrevisite.textContent = 'Date de la visite';
        var datevisit = document.createElement("p");
        datevisit.textContent = article.when;
        var idvisite = document.createElement("h2");
        idvisite.textContent = 'ID de la visite';
        var IDvisit = document.createElement("p");
        IDvisit.textContent = article.id;
    
        var imageElt = document.createElement("img");
        imageElt.src = "../../images/calendrier.jpg";
        
        articlesElt.appendChild(imageElt);
        articlesElt.appendChild(idvisite);
        articlesElt.appendChild(titrevisite);
        titrevisite.appendChild(datevisit);
        idvisite.appendChild(IDvisit);
